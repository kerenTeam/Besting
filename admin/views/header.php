  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        <li class="admin-parent"><a href="<?php echo site_url('pc_index/admin')?>"><span class="am-icon-home"></span> 管理中心</a></li>

        <li class="admin-parent">
          <a class="am-cf" href="<?php echo site_url('pc_index/index')?>"><span class="am-icon-desktop"></span> 官网-首页设置 </a>
        </li>
        ...
        <li class="admin-parent">
          <a class="am-cf" href="<?php echo site_url('wx_index/pic')?>"><span class="am-icon-weixin"></span> 微信-banner图片管理 </a>
        </li>
        <li class="admin-parent">
          <a class="am-cf" href="<?php echo site_url('wx_index/type')?>"><span class="am-icon-weixin"></span> 微信-分类管理 </a>
        </li>
        <li class="admin-parent">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
            <li><a href="<?php echo site_url('pc_index/partner')?>"><span class="am-icon-credit-card-alt"></span> 时间银行</a></li>
            <li><a href="<?php echo site_url('pc_index/pageimg')?>"><span class="am-icon-cart-arrow-down"></span> 精品商城</a></li>
          </ul>
        </li>
       <li class="admin-parent">
          <a class="am-cf" data-am-collapse="{target: '#collapse-nav3'}"><span class="am-icon-weixin"></span> 微信-商家管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
      ...
      <div class="am-panel am-panel-default admin-sidebar-panel">
        <div class="am-panel-bd">
          ...
          <p>Welcome to the BestingMedia wiki!</p>
        </div>
      </div>
