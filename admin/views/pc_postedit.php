...
<div class="admin-content">
  ...
  <div class="am-g">
    ...
    <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
      <!-- 表单 start -->
      <form action="<?=site_url('pc_newpost/postedit')?>" method="post" enctype="multipart/form-data" class="am-form am-form-horizontal">
        <div class="am-form-group">
          <label class="am-u-sm-3 am-form-label">标题</label>
          <div class="am-u-sm-9">
            <input type="text" placeholder="标题" value="<?=$post['title']?>" name='title'>
          </div>
        </div>
        <div class="am-form-group">
          <label class="am-u-sm-3 am-form-label">简介</label>
          <div class="am-u-sm-9">
            <textarea rows="4" placeholder="简短说明" name='postinfo'><?=$post['postinfo'];?></textarea>
          </div>
        </div>
        <div class="am-form-group">
          ...
          <div class="am-u-sm-9">
            ...
            <!-- 图片实时预览 -->
            <input type="hidden" name='postpic' value="<?=$post['postpic'];?>">
            <div id="preview"> <img style="border-radius: 3px;" alt="选择图片" src="<?=base_url($post['postpic']);?>"> </div>
          </div>
        </div>
        <div class="am-form-group">
          ...
          <div class="am-u-sm-9">
            ...
            <div style="margin-left: -20px;">
              <script id="myEditor" type="text/plain" style="width:90%;height:500px;" name='postcontent'><?=$post['postcontent'];?></script>
            </div>
