       ...
       <!-- 表单start -->
        <form action="<?=site_url('wx_product/bankedit');?>" method="post" enctype="multipart/form-data" class="am-form am-form-horizontal">
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" placeholder="风蛋糕师傅" name='bankname'>
            </div>
          </div>
         <div class="am-form-group">
            <label class="am-u-sm-3 am-form-label">作者</label>
            <div class="am-u-sm-9">
              <input type="text" placeholder="的" name='bankname'>
            </div>
          </div>
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9"> 
                <select data-am-selected="{btnSize: 'sm'}" name='gid'>
                  ...
                  <option value="人间" selected>知道</option> 
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="" name='profiles' rows="5" id="user-intro" placeholder="是打发打发打发大大的身份"></textarea>
