  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
       <!-- 表单start -->
        <form action="<?=site_url('wx_product/malladd')?>" method="post" enctype="multipart/form-data" class="am-form am-form-horizontal">
          <div class="am-form-group">
            <label class="am-u-sm-3 am-form-label">商品名</label>
            <div class="am-u-sm-9">
              <input type="text" placeholder="" name='goodsname'>
            </div>
          </div>
          <div class="am-form-group">
            <label class="am-u-sm-3 am-form-label">计量单位</label>
            <div class="am-u-sm-9">
              <input type="text" placeholder="" name='specifications'>
            </div>
          </div>
          <div class="am-form-group">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" placeholder="" name='numbers'>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9"> 
                ...
                <?php foreach($shops as $shop):?>
                  <option value="<?=$shop['sid'];?>"><?=$shop['shopsname']?></option>
                <?php endforeach;?>
                   </select>
              </div> 
          </div>
           ...
           <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <label class="am-checkbox-inline">
                <input type="checkbox"  value="红色" name='color[]' data-am-ucheck> 红色
              </label>
              <label class="am-checkbox-inline">
                <input type="checkbox"  value="白色" name='color[]' data-am-ucheck> 白色
              </label>
              <label class="am-checkbox-inline">
                <input type="checkbox"  value="黑色" name='color[]' data-am-ucheck> 黑色
              </label>
              <label class="am-checkbox-inline">
                <input type="checkbox"  value="银色" name='color[]' data-am-ucheck> 银色
              </label>
              <label class="am-checkbox-inline">
                <input type="checkbox"  value="绿色" name='color[]' data-am-ucheck> 绿色
              </label>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
               <input type="file" id="imgUpload" name="goodspic" onchange="previewImage(this)" class="upload-add">
                  <!-- 图片实时预览 -->
