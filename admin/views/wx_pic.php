      ...
      <div class="am-u-sm-12 am-u-md-8">
        <form action=" " method=" " enctype="multipart/form-data" class="am-form am-form-horizontal">
          <div class="am-form-group">
            <label class="am-u-sm-3 am-form-label">banner1:</label>
            <div class="am-u-sm-9 wx_img">
          ...
          <div class="am-form-group">
            <label class="am-u-sm-3 am-form-label">banner2:</label>
            <div class="am-u-sm-9 wx_img">
              <div class="wx_type_img">
                <input type="file" id="imgUpload" name="img[]" onchange="previewImage(this)" class="upload-add">
                <!-- 图片实时预览 -->
          ...
          <div class="am-form-group">
            <label class="am-u-sm-3 am-form-label">banner3:</label>
            <div class="am-u-sm-9 wx_img">
              <div class="wx_type_img">
                <input type="file" id="imgUpload" name="img[]" onchange="previewImage(this)" class="upload-add">
                <!-- 图片实时预览 -->
